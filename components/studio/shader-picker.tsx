        ...
        {CATEGORIES.map((c) => {
          ...
          return (
            <button
              ...
              className={`flex-1 rounded-md px-2 py-1.5 text-center font-mono text-[10px] uppercase tracking-[0.12em] transition-colors ${FOCUS} ${
                active
            ...
            >
              {c.label}
              <span className="ms-1 text-muted-foreground">{c.shaders.length}</span>
            </button>
          );
        })}
      </div>
        ...
        {group.shaders.map((s) => {
          ...
          return (
            <button
              ...
              className={`rounded-md border px-2.5 py-1.5 text-[12px] transition-colors ${FOCUS} ${
                active
